...
data_profiles <- read.table("Clusterdat_n25.csv", sep = ";", header = T)
...
pdf("test.pdf", width = 1.8, height = 8)
...
grid.arrange(p_volcanos,p_corrs,p_profiles, heights = c(1,0.2,1.3), layout_matrix = rbind(c(1),c(NA),c(2)))
